...
const char* LISTEN_IP_PORT = "udp://127.0.0.1:8554";
...
int main(int argc, char* argv) {
	...
	if (!video_reader_open(&vr_state, LISTEN_IP_PORT)) {
	...
	int window_width = vr_state.width;
	int window_height = vr_state.height;
	window = glfwCreateWindow(frame_width, frame_height, "Stream", NULL, NULL);
	if (!window) {
